export default {
    ...
    plugins: [
        ...
        '~/plugins/mixins/admin/activities.js',
        '~/plugins/mixins/admin/adminsWorkers.js',
        '~/plugins/mixins/admin/coaches.js',
        '~/plugins/mixins/admin/players.js',
        '~/plugins/mixins/admin/belts.js',
    ],
